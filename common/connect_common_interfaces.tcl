...
if {!$set_ddr_memory} {
  ...
  connect_bd_intf_net -intf_net M_AXI_OUTPUT_PORT [get_bd_intf_ports M_AXI] [get_bd_intf_pins dmaOffset/M_AXI]
  ...
  lappend axi_mem_slaves [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  if {[info exists iaxi]} {
    connect_bd_intf_net -intf_net M_AXI_OUTPUT_PORT [get_bd_intf_ports M_AXI] [get_bd_intf_pins axi_merge_interconnect_1/M00_AXI]
    lappend axi_mem_slaves [get_bd_intf_pins axi_merge_interconnect_1/S01_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_merge_interconnect_1/S00_AXI] $iaxi
  } else {
    set_property CONFIG.NUM_MI {2} [get_bd_cells axi_mem_intercon_1]
    connect_bd_intf_net [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins axi_mem_intercon_1/M00_AXI]
    connect_bd_intf_net [get_bd_intf_ports M_AXI] -boundary_type upper [get_bd_intf_pins axi_mem_intercon_1/M01_AXI]
  }
}

# configure and connect axi_mem_intercon_1
if {[llength $axi_mem_slaves] == 1 && !$set_ddr_memory} {
...
} elseif {!$set_ddr_memory || [info exists iaxi]} {
