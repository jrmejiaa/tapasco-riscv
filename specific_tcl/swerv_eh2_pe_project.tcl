...
if { $set_cache_sys && [dict get $is_cache_available $project_name] } {
  ...
  connect_bd_intf_net -intf_net VexRiscvAxi4_0_dBusAxi [get_bd_intf_pins swerv_eh2_0/lsu_axi] [get_bd_intf_pins cache_system_0/core_dmem]
  connect_bd_intf_net -intf_net piccolo_0_cpu_imem_master [get_bd_intf_pins swerv_eh2_0/ifu_axi] [get_bd_intf_pins cache_system_0/core_imem]
...
if {!$set_ddr_memory} {
  ...
  if { $set_cache_sys && [dict get $is_cache_available $project_name] } {
    ...
    proc create_specific_addr_segs {} {
      ...
      # Create specific address segments
      create_bd_addr_seg -range 0x00010000 -offset 0x11000000 [get_bd_addr_spaces swerv_eh2_0/lsu_axi] [get_bd_addr_segs RVController_0/saxi/reg0] SEG_RVController_0_reg0
      create_bd_addr_seg -range $lmem -offset $lmem [get_bd_addr_spaces swerv_eh2_0/lsu_axi] [get_bd_addr_segs M_AXI/Reg] M_AXI_DMem0
      create_bd_addr_seg -range $lmem -offset 0x00000000 [get_bd_addr_spaces swerv_eh2_0/ifu_axi] [get_bd_addr_segs M_AXI/Reg] M_AXI_IMem0
    }
