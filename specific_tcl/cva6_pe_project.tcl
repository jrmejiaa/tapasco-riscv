...
if { $set_cache_sys && [dict get $is_cache_available $project_name] } {
  # Create interface connections
  connect_bd_intf_net -intf_net cva6_0_cpu_dmem_master [get_bd_intf_pins cva6_mem_splitter/M01_AXI] [get_bd_intf_pins cache_system_0/core_dmem]
  connect_bd_intf_net -intf_net cva6_0_cpu_imem_master [get_bd_intf_pins cva6_mem_splitter/M02_AXI] [get_bd_intf_pins cache_system_0/core_imem]

  # Connect to dmem AXI port
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins cache_system_0/dmem] [get_bd_intf_pins axi_mem_intercon_1/S00_AXI]
  ...
  set axi_mem_port [get_bd_intf_pins cache_system_0/dmem]
} else {
  # Connect to dmem AXI port
