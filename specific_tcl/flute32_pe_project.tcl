...
if { $set_cache_sys && [dict get $is_cache_available $project_name] } {
  ...
  connect_bd_intf_net -intf_net flute32_0_cpu_dmem_master [get_bd_intf_pins cache_system_0/core_dmem] [get_bd_intf_pins flute32_0/core_mem_master]
  connect_bd_intf_net -intf_net flute32_0_cpu_imem_master [get_bd_intf_pins cache_system_0/core_imem] [get_bd_intf_pins flute32_0/cpu_imem_master]
